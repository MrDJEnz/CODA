									...
									<?php
									$query = 'SELECT pmkID, flduserName, fldhashedPass, flddate, flddoctorName, flddetails FROM tblUserAppointments  WHERE flduserName = ? AND fldhashedPass = ? AND pmkID = ?';
																...
																<div class="card-body">
																	...
																	<div class="text-center">
																		...
																		<div class="md-form">
																			...
																			<input type="date" id="date" name = "date" class="white-text form-control" value="<?php echo $record['flddate'];?>">  
																			<label for="date" class="active">Appointment Date</label>
																		</div>

																		<div class="md-form">
																			<i class="fa fa-envelope prefix white-text active"></i>
																			<input type="text" id="doc" name = "doc" class="white-text form-control" value="<?php echo $record['flddoctorName'];?>">
																			<label for="doc" class="active">Doctor Name</label>
																		</div>

																		<div class="md-form">
																			<i class="fa fa-envelope prefix white-text active"></i>
																			<input type="text" id="details" name = "details" class="white-text form-control" value="<?php echo $record['flddetails'];?>">
